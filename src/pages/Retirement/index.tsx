        ...
        <Wrapper id="issuance-page">
          ...
          { ((arecSelected !== undefined) && allARECInfo[arecSelected]?.status === REC_STARUS.Certified) && (
            <AutoColumn gap="4px" style = {{padding:'0.4rem 0.8rem 0rem 0.8rem'}} >
              <RowBetween align="center" height='24px'> 
                <RowFixed>
                  <Text fontWeight={700} fontSize={16} color={theme.text2}> The selected AREC will be redeemed. </Text>
                  <QuestionHelper bkgOff={true} small={true} info={<> The selected AREC will be redeemed,
                      and one redeem action is created and recorded on blockchain. Based on this redeem action,
                      you could mint AREC retiremnet NFT at anytime later.</>} />
                </RowFixed>
              </RowBetween>   
              <div style = {{paddingLeft:'1rem'}}>
                <div>    
                  <input type="radio" id="redeem" name="redeem" value="redeem" checked={true} />
                  <label htmlFor='redeem'>Redeem as an action</label>
                </div>
                <div>
                  <input type="radio" id="redeem_mint" name="redeem" value="redeem_mint" />
                  <label htmlFor='redeem_mint' >Redeem and mint retirement certificate </label>
                </div>
              </div>
            </AutoColumn>
          )}
